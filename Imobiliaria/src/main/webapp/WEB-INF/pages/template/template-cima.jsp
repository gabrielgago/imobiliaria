...
<body>
	<div class="page-wrapper chiller-theme toggled">
				...
				<div class="sidebar-menu">
					<ul>
						...
						<li class="sidebar-dropdown"><a href="#"> <i
								class="fa fa-tachometer-alt"></i> <span>Cadastros</span> <span
								class="badge badge-pill badge-warning">Novo</span>
						</a>
							<div class="sidebar-submenu">
								<ul>
									...
									<li><a href="<c:url value = "/cadastros/locadores"/>">Cadastro
											de Locadores</a></li>
									<li><a href="<c:url value = "/cadastros/locatarios"/>">Cadastro
											de Locatarios</a></li>
						...
						<li class="sidebar-dropdown"><a href="#"> <i
								class="fa fa-shopping-cart"></i> <span>Relatórios</span> <span
								class="badge badge-pill badge-danger">3</span>
						</a>
							<div class="sidebar-submenu">
								<ul>
									<li><a href="#">Produtos </a></li>
									<li><a href="#">Ecnomendas</a></li>
									<li><a href="#">Carrinho de créditos</a></li>
								</ul>
							</div></li>
		...
		<!-- sidebar-wrapper  -->
		<main class="page-content gb-conteudo">