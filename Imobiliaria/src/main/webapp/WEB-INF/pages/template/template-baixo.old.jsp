					...
					<div
						...
						<ul>
							<li class="gb-h-activo"
								onclick="redirect('<c:url value = "/cadastros/imoveis"/>');">Imoveis</li>
							<li class="gb-h-activo"
								onclick="redirect('cadastros/locadores');">Locadores</li>
							<li class="gb-h-activo"
								onclick="redirect('cadastros/locatarios');">Locatarios</li>
