		...
		<tbody>
			...
			<tr class="hidden hidden-geral">
				...
				<td class="entrada"><input type="number" class="input codigo" />
					<i class="fas fa-sync-alt atualizar atualizar-codigo"></i></td>
			</tr>
			<tr class="hidden hidden-geral">
			...
			<tr class="hidden hidden-endereco">
				...
				<td class="entrada"><input type="number" class="input cep" /></td>
			</tr>
			<tr class="hidden hidden-endereco">
				<td class="label">Rua</td>
				<td class="entrada"><input type="text" class="input rua" /></td>
			</tr>
			<tr class="hidden hidden-endereco">
